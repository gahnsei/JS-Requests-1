...
const sayHelloBackground = (event) => {
...
sayHelloButton.addEventListener(`mouseout`, sayHelloBackgroundBack);
...
const repeatMyParam = () => {
    axios.get(`http://localhost:3000/repeat/Sei`)
        .then(res => {
...
const query = () => {
    axios.get('http://localhost:3000/query-test/?animals=5434f/?ggr=nrgoinr')
    .then(res => {
